...
const ClientModule = ['AUTH', 'MEDIA', 'PROFILE', 'CART', 'BRAND', 'ORDERS', 'PAYMENT', 'REVIEWS', 'MESSAGES', 'CATEGORY', 'SELLER-REGISTRATION', 'SHIPPING-METHODS', 'DISCOUNT-CODES', 'PAYMENT-METHODS'];
